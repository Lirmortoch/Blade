...
function hidePopUp(e) {
    ...
    // document.querySelector('.pop-up__title').clearHTMLElement().classList.remove('title-check-mark');
    // document.querySelector('.pop-up__main-part').clearHTMLElement();
}
function showPopUpContent(e) {
    ...
    const btnText = btn.closest('.open-modal-btn-text').textContent.toLowerCase();
    const title = document.querySelector('.pop-up__title');
    ...
    if (btnText === 'купить') {
            ...
            `
                <form class='pop-up__form pop-up-form' action='#' method='POST'>
                        <fieldset class='pop-up-form__group'>
                            <label class='pop-up-form__label' for='input-name'>Имя</label>
                        ...
                        <fieldset class='pop-up-form__group'>
                            <legend class='pop-up-form__label'>Статус билета</legend>
                
                            <div class="pop-up-form__radio-group">
                                <input class='pop-up-form__input' type='radio' name='input-radio-viewer' id='input-radio-viewer' value='viewer'>
                                <label for='input-radio-viewer'>Зритель</label>
                                
                                <input class='pop-up-form__input' type='radio' name='input-radio-optimum' id='input-radio-optimum' value='optimum'>
                                <label for='input-radio-optimum'>Оптимум</label>
                                
                                <input class='pop-up-form__input' type='radio' name='input-radio-vip' id='input-radio-vip' value='vip'>
                                <label for='input-radio-vip'>VIP</label>
                            </div>
                        </fieldset>

                        <button class="pop-up__tickets-btn buy-tickets-btn open-modal-btn uppercase">
        ...
        elem = 
            `
                ...
                <button class='pop-up__close-btn pop-up-button uppercase'>Понятно</button>
            `;
        ...
        elem = 
            `
                <form class='pop-up__form pop-up-form' action='#' method='POST'>
                        ...
                        <button type='submit' class='pop-up-form__submit-btn open-modal-btn-text pop-up-button uppercase'>Отправить</button>
                </form>
            `;
    ...
    title.clearHTMLElement().append(titleContent);
...
function createPopUp() {
    document.body.insertAdjacentHTML(
        'beforeend', 
        `<div class='pop-up pop-up-background active'>
